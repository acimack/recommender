...
public class BiasTest {
    ...
    static AttributeDataset<Candidate> candidates;
...
//        allCandidates = (LinkedList<Candidate>) parser.parse(Candidate.class, filepath, ',', true);
        ...
        BiasTest.candidates = new AttributeDataset<Candidate>(canAttr, allCandidates);
    }
...
//        newCandMale = (LinkedList<Candidate>) parser.parse(Candidate.class, "testing_cis_male_correlated.csv", ',', true);
        // parse the female testing dataset
        /**
         * TODO: While testing correlated variables, change filepath from
         * "testing_cis_female.csv" to "testing_cis_female_correlated.csv"
         */
//        newCandFemale = (LinkedList<Candidate>) parser.parse(Candidate.class, "testing_cis_female_correlated.csv", ',', true);
